'''
2 layer，64 nodes per layer, ReLU, Adam，0.001, 3000epoch，early stop:5
Hand-crafted + Metadata + MLP

Input (28 features)
    ↓
Dense Layer 1 (64 nodes) + ReLU
    ↓
Dense Layer 2 (64 nodes) + ReLU
    ↓
Output Layer (1 node)
'''
import time
...
class PastureBiomassPredictor:
    ...
    def train(self, train_csv_path, image_dir='/kaggle/input/csiro-biomass/train'):
        ...
        for target_name in self.target_names:
            ...
            print(f"Training MLP with {input_dim} input features...")
